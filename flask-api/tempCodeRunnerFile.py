...
from module.generate_ticket import generate_exam_ticket
...
def verify_face():
    try:
        ...
        if result['match']:
            # Generate exam ticket as before
            seating_position = generate_exam_ticket.seating_position
            exam_account = generate_exam_ticket.exam_account
            exam_password = generate_exam_ticket.exam_password
