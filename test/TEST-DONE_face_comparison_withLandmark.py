...
image1 = cv2.imread(r'D:\Edu\Python\StudentID_FaceVerification\student-id-face-matching\results\student_card_faces\NgocAnhIDCard.jpg_face.jpg')
image2 = cv2.imread(r'D:\Edu\Python\StudentID_FaceVerification\student-id-face-matching\uploads\NgocAnh_face.jpg')
